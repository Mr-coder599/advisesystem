             ...
             <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            $sqldel="DELETE from students where id='$gid'"; 
                              	...
                              	$matricno=$_GET["matricno"];
                                        ...
                                        <tr>
                                            <th>SN</th><td> <?php echo $row["id"]; ?></td></tr>
                                                ...
                                                <tr><td><a href="?delete&id=<?php echo $row["id"]; ?>"><input type="submit" name="delete" class="btn btn-space btn-secondary" value="Delete"/></a></td> 
                                                </tr>
