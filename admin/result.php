...
echo("<script>alert('Exam result not found for this candidate');</script>");
echo("<script>window.location.href='view-result.php'</script>");
                                   }
...
<header>
	<h1 align="center"><!-- <img src="../images/logo2.png" width="200"> -->HUBAYDAH ISLAMIC COLLEGE <br> <span style="font-size:20pt;">Ede, Osun State , Nigeria</span>	</h1>
<hr>
</header>
