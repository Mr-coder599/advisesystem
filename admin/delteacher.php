                              	...
                              	$username=$_GET["username"];
                                        ...
                                        if($result->num_rows > 0){
                                            while($row=$result->fetch_assoc()){?>
                                            	<tr>  <td><img src="images/<?php echo $row["image"]; ?>" width="300px"></td> </tr>
                                        ...
                                        <tr>
                                            <th>SN</th><td> <?php echo $row["id"]; ?></td></tr>
                                                ...
                                                <tr><td><a href="?delete&username=<?php echo $row["username"]; ?>"><input type="submit" name="delete" class="btn btn-space btn-secondary" value="Delete"/></a></td> 
                                                </tr>
